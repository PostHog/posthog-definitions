...
export interface components {
    schemas: {
        ...
        Experiment: {
            ...
            /**
             * @description When true, sync the flag config sent in this request (via the `feature_flag` object, or the deprecated `parameters` keys) to the linked feature flag. Draft experiments always sync regardless. On a running experiment, `feature_flag` config without this flag is rejected.
             * @default false
             */
