...
export interface components {
    schemas: {
        ...
        Experiment: {
            ...
            version?: number | null;
            /** @description The metric collections as the client last read them, used together with `version` to resolve concurrent metric edits: changes made by other users are merged per metric uuid where safe instead of failing. Relevant keys are metrics, metrics_secondary, and saved_metrics_ids; unknown keys are ignored. Without it, any version mismatch fails with HTTP 409. */
            original_experiment?: {
                [key: string]: unknown;
            } | null;
