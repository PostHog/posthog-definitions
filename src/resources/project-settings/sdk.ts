 ...
 * (`PatchedProjectBackwardCompat` — the Team→Project migration successor to the
 * former `PatchedTeam`) with the server-managed identifiers, tokens, and
 * computed fields omitted. Every key
