...
import { logsSamplingRuleResource } from "./logs-sampling-rule/index.js";
...
const REGISTRY: ReadonlyArray<ResourceModule<unknown, unknown>> = [
  ...
  logsSamplingRuleResource as ResourceModule<unknown, unknown>,
...
export { logsSamplingRuleResource } from "./logs-sampling-rule/index.js";
