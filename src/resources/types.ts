...
export type ApplyContext = {
  ...
  /** Feature-flag server id by spec key. Populated by the feature-flag module's executor; read by the survey module to resolve linked/targeting flag references. */
