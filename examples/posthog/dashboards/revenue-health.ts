...
export default dashboard({
  ...
  tiles: [
    ...
    { insight: trialStarts, layout: { x: 0, y: 1, w: 6, h: 4 } },
    { insight: upgrades, layout: { x: 6, y: 1, w: 6, h: 4 } },
    { insight: churnEvents, layout: { x: 0, y: 5, w: 6, h: 4 } },
    { insight: seatExpansion, layout: { x: 6, y: 5, w: 6, h: 4 } },
    { insight: mrrByPlan, layout: { x: 0, y: 9, w: 12, h: 4 } },
  ],
});
